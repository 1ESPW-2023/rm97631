...
inputUser.addEventListener("focus", ()=>{
    inputUser.setAttribute("style","outline-color:#ff4582;")
});
...
inputUser.addEventListener("keyup", ()=>{
    ...
    if(inputUser.value.length < 5){
        inputUser.setAttribute("style","outline-color:#ff4582;")
        labelUser.setAttribute("style","color:#ff4582;")

    }else{
        inputUser.setAttribute("style","outline-color:#00ff82;")
        labelUser.setAttribute("style","color:#00ff82;")
    }
});
